...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $albums = Album::limit('4')->where('country_id', '<', 6)->orderByRaw('RAND()')->get();
        ...
        return view('home', compact('zar_news','busad_news', 'students', 'albums', 'schools', 'busad_news2','main_slide'));
    }
